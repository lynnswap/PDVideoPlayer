...
Add `PDVideoPlayer` to your project using Swift Package Manager. In Xcode choose **File \> Add Packages...** and enter the package URL for this repository. Alternatively, you can declare it in your `Package.swift`:
